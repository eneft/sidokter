...
export const UserPasswordTab: React.FC<UserPasswordTabProps> = ({
  userSession,
  onLogout,
  onUpdatePassword,
  onShowToast
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!newPassword.trim() || newPassword.length < 8) {
      setErrorMessage('Kata sandi baru minimal 8 karakter dan harus mengandung huruf besar, huruf kecil, dan angka.');
      return;
    }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-1">
              Perbarui kata sandi akun user Anda secara mandiri untuk menjaga keamanan akses naskah SPO.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-800 mt-0.5">
                  {userSession.unitName || 'User Unit'}
                </p>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Minimal 8 karakter, terdiri dari huruf besar, huruf kecil, dan angka."
                    className="w-full text-xs px-3.5 py-2.5 border border-slate-300 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 pr-10"
                    required
                  />
                  <button
                ...
                {newPassword && (
                  <div className="mt-1.5 flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-slate-500 font-semibold">
                      {newPassword.length < 8 ? 'Cukup' : newPassword.length < 12 ? 'Kuat' : 'Sangat Kuat'}
                    </span>
                  </div>
                )}
              </div>
