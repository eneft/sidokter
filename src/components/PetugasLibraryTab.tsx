...
export const PetugasLibraryTab: React.FC<PetugasLibraryTabProps> = ({
  ...
  const filteredSops = accessibleSops.filter((s) => {
    ...
    // Pencarian hanya berdasarkan judul SPO. Detail isi tidak digunakan.
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Perpustakaan Banner */}
      <div className="bg-gradient-to-r from-emerald-900 via-teal-900 to-slate-900 text-white rounded-2xl p-6 sm:p-7 shadow-sm border border-emerald-700/50 relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-bold border border-emerald-500/40">
              ...
              <span>Arsip Digital Resmi RSUD Dr. Soegiri</span>
            </div>
            <h2 className="text-xl sm:text-2xl font-black text-white tracking-tight">
              Perpustakaan SPO (Standar Prosedur Operasional)
            </h2>
            <p className="text-xs sm:text-sm text-emerald-100/85 max-w-2xl leading-relaxed">
              Jelajahi dan telusuri seluruh naskah SPO resmi rumah sakit yang terdaftar pada unit kerja Anda. Menampilkan dokumen SPO sesuai kewenangan akun Anda dengan tampilan sederhana dan responsif.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
            <div>
              <div className="flex items-center gap-2 text-emerald-900 font-extrabold text-sm">
                ...
                Anda memiliki akses ke {assignmentSummary.length} hirarki unit kerja
              </div>
              <p className="text-[11px] text-emerald-800/80 mt-1">
                Dokumen dari seluruh kewenangan Anda dan hirarki turunannya ditampilkan bersama.
              </p>
            </div>
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-sm border border-slate-200 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Cari berdasarkan judul SPO..."
      ...
      <div className="flex items-center justify-between text-xs text-slate-500 px-1 flex-wrap gap-2">
        <div className="flex items-center gap-1.5">
          <span>
            Menampilkan <strong>{filteredSops.length}</strong> naskah SPO yang dapat diakses oleh akun Anda
          </span>
          {isRestricted && (
