...
import { RichTextEditor, PRESET_COLORS, FONT_SIZES, compressImageToDataUrl } from './RichTextEditor';
    ...
    <div className="space-y-3.5">
      ...
      {viewMode === 'table' && (
        <div className="space-y-2.5 animate-fadeIn">
          ...
          <div className="sticky top-2 z-30 w-full max-w-[900px] mx-auto bg-slate-900 text-slate-100 rounded-xl shadow-lg border border-slate-700/80 px-2 py-1 flex items-center justify-between gap-1 text-xs select-none backdrop-blur-md">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <select
                ...
                className="h-6 text-[11px] font-bold text-white bg-slate-800 border border-slate-700 rounded-lg px-2 py-0 focus:outline-none focus:ring-1 focus:ring-indigo-400 cursor-pointer"
              >
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              <button
                ...
                title="Undo (Ctrl+Z)"
                className="w-6 h-6 p-1 rounded hover:bg-slate-800 text-slate-300 hover:text-white transition-colors cursor-pointer flex items-center justify-center"
              >
            ...
            <div className="w-px h-4 bg-slate-700 mx-0.5 shrink-0 hidden sm:block" />
            ...
            <div className="hidden sm:flex items-center shrink-0">
              <select
                ...
                title="Ukuran Huruf"
                className="h-6 text-[10px] font-medium text-white bg-slate-800 border border-slate-700 rounded px-1 py-0 focus:outline-none focus:ring-1 focus:ring-indigo-400 cursor-pointer"
              >
                {FONT_SIZES.map((f) => (
            ...
            <div className="relative shrink-0">
              <button
                ...
                title="Warna Teks"
                className="w-6 h-6 p-1 rounded hover:bg-slate-800 text-slate-300 hover:text-white transition-colors cursor-pointer flex items-center justify-center gap-0.5"
              >
            ...
            <div className="w-px h-4 bg-slate-700 mx-0.5 shrink-0 hidden md:block" />
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              <button
                ...
                className="h-6 px-1.5 text-[10px] font-bold rounded bg-indigo-600 hover:bg-indigo-500 text-white cursor-pointer flex items-center justify-center transition-colors"
              >
                1.
              </button>
              <button
                ...
                className="h-6 px-1.5 text-[10px] font-bold rounded bg-slate-800 hover:bg-slate-700 text-indigo-300 hover:text-white cursor-pointer flex items-center justify-center transition-colors"
              >
                a.
              </button>
              <button
                ...
                className="w-6 h-6 p-1 rounded hover:bg-slate-800 text-slate-300 hover:text-white cursor-pointer flex items-center justify-center transition-colors"
              >
            ...
            <table className="w-full min-w-[620px] sm:min-w-[720px] border-collapse table-fixed font-bookman text-black" style={{ border: '1px solid #000' }}>
              ...
              <tbody>
                ...
                <tr className={isPengertianMissing ? 'bg-rose-50/40' : ''}>
                  ...
                  <td colSpan={3} className={`border border-black p-1 sm:p-1.5 align-top font-bookman sop-batang-tubuh-content ${isPengertianMissing ? 'bg-rose-50/50' : ''}`}>
                    <RichTextEditor
                      label=""
                      value={pengertian}
                      onChange={onPengertianChange}
                ...
                <tr className={isTujuanMissing ? 'bg-rose-50/40' : ''}>
                  ...
                  <td colSpan={3} className={`border border-black p-1 sm:p-1.5 align-top font-bookman sop-batang-tubuh-content ${isTujuanMissing ? 'bg-rose-50/50' : ''}`}>
                    <RichTextEditor
                      label=""
                      value={tujuan}
                      onChange={onTujuanChange}
                ...
                <tr className={isKebijakanMissing ? 'bg-rose-50/40' : ''}>
                  ...
                  <td colSpan={3} className={`border border-black p-1 sm:p-1.5 align-top font-bookman sop-batang-tubuh-content ${isKebijakanMissing ? 'bg-rose-50/50' : ''}`}>
                    <RichTextEditor
                      label=""
                      value={kebijakan}
                      onChange={onKebijakanChange}
                ...
                <tr className={isProsedurMissing ? 'bg-rose-50/40' : ''}>
                  ...
                  <td colSpan={3} className={`border border-black p-1 sm:p-1.5 align-top font-bookman sop-batang-tubuh-content ${isProsedurMissing ? 'bg-rose-50/50' : ''}`}>
                    <RichTextEditor
                      label=""
                      value={prosedur}
                      onChange={onProsedurChange}
                ...
                <tr className={isUnitTerkaitMissing ? 'bg-rose-50/40' : ''}>
                  ...
                  <td colSpan={3} className={`border border-black p-1 sm:p-1.5 align-top font-bookman sop-batang-tubuh-content ${isUnitTerkaitMissing ? 'bg-rose-50/50' : ''}`}>
                    <RichTextEditor
                      label=""
                      value={unitTerkait}
                      onChange={onUnitTerkaitChange}
