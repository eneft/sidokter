...
export function uploadMOU(file: File, title: string, uploadedBy?: string, actorRole?: UserRole, metadata?: any) { return uploadDocument(file, MOU_TYPE, title, uploadedBy, actorRole, metadata); }
